...
public class FavoriteController {
    ...
    @GetMapping
    public ResponseEntity<List<Long>> getFavoriteMovies(Authentication authentication) {
        String userEmail = authentication.getName();
        List<Long> favoriteMovieIds = favoriteService.getFavoriteMovieIds(userEmail);
