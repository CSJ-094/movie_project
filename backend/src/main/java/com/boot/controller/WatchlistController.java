...
public class WatchlistController {
    ...
    @PostMapping("/{movieId}")
    public ResponseEntity<Boolean> toggleWatchlist(@PathVariable String movieId) {
    ...
    @GetMapping("/{movieId}")
    public ResponseEntity<Boolean> isMovieInWatchlist(@PathVariable String movieId) {
    ...
    public ResponseEntity<Boolean> toggleWatchedStatus(@PathVariable String movieId) {
